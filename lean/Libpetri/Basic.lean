...
Models `bitmap_backend.rs:329 can_enable` (enablement) and
`bitmap_backend.rs:715 consume_for_firing` + `:840 produce_token` (effect).
-/
...
/-- Concrete enablement (`can_enable`, `bitmap_backend.rs:329`, minus timing

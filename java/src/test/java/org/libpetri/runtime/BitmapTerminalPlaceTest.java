...
/** {@link AbstractTerminalPlaceTest} against the reference executor. */
class BitmapTerminalPlaceTest extends AbstractTerminalPlaceTest {
    @Override
    protected PetriNetExecutor create(
        ...
        var builder = BitmapNetExecutor.builder(net, initial).environmentPlaces(environmentPlaces);

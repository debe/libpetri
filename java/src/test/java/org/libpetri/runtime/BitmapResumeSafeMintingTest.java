...
/** {@link AbstractResumeSafeMintingTest} against the reference executor. */
class BitmapResumeSafeMintingTest extends AbstractResumeSafeMintingTest {
    @Override
    ...
    protected void pinScope(String scope) {
        BitmapNetExecutor.builder(PetriNet.builder("empty").build(), Map.of()).executionScope(scope);
    }
}

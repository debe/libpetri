...
/**
 * Exports TCPN models to Sirio's PetriNet format for formal analysis.
 *
 ...
 * converts TCPN models to Sirio's object model for programmatic analysis.
 *
 ...
 * <h2>Mapping Rules</h2>
 * <table border="1">
 *   <caption>TCPN to Sirio mapping</caption>
 *   <tr><th>TCPN Element</th><th>Sirio Element</th></tr>
...
public final class SirioExporter {
    ...
    /**
     * Result of exporting a TCPN to Sirio format.
     *
    ...
    /**
     * Exports a TCPN to Sirio format with empty initial marking.
     *
     * <p>Use {@link #export(PetriNet, String)} to set initial tokens.
     *
     * @param tcpn the TCPN to export
     * @return Sirio net with empty marking
     */
    public static SirioNet export(PetriNet tcpn) {
    ...
    /**
     * Exports a TCPN to Sirio format with one token in the start place.
     *
     * @param tcpn the TCPN to export
     * @param startPlace name of the place to receive initial token
     * @return Sirio net with initial token
     */
    public static SirioNet export(PetriNet tcpn, String startPlace) {
        var result = export(tcpn);
    ...
    /**
     * Exports a TCPN to Sirio format with custom initial marking.
     *
     * @param tcpn the TCPN to export
     * @param initialTokens map of place names to token counts
     * @return Sirio net with specified initial marking
     */
    public static SirioNet export(PetriNet tcpn, Map<String, Integer> initialTokens) {
        var result = export(tcpn);

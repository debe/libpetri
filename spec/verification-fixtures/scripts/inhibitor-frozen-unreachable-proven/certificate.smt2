...
; VC1 initiation (VC1)
(push)
(assert (not (and (Reachable 1 1 0) (= (* 1 1) 1) (= (+ (* 1 1) (* 1 0)) 1))))
(check-sat)
(pop)
...
(assert (>= m1 0))
(assert (>= m2 0))
(assert (and (Reachable m0 m1 m2) (= (* 1 m0) 1) (= (+ (* 1 m1) (* 1 m2)) 1)))
(assert (and (>= m1 1) (= m0 0) (= m0p m0) (= m1p (- m1 1)) (= m2p (+ m2 1)) (>= m0p 0) (>= m1p 0) (>= m2p 0)))
(assert (not (and (Reachable m0p m1p m2p) (= (* 1 m0p) 1) (= (+ (* 1 m1p) (* 1 m2p)) 1))))
(check-sat)
(pop)

...
export const GRAPH: GraphStyle = { nodesep: $GRAPH_NODESEP, ranksep: $GRAPH_RANKSEP, forcelabels: $GRAPH_FORCELABELS, overlap: $GRAPH_OVERLAP, outputorder: '$GRAPH_OUTPUTORDER' };
